/**
 * @file src/lib/schemas/journeys.ts
...
const AddressSchema = z.object({
  ...
  label: z.string(),
  administrative_regions: z.array(z.object({
    id: z.string(),
    name: z.string(),
    level: z.number(),
    zip_code: z.string(),
...
const StopPointSchema = z.object({
  ...
  coord: CoordinateSchema,
  links: z.array(LinkSchema),
  commercial_modes: z.array(z.object({
    id: z.string(),
    name: z.string(),
  })),
...
const DisruptionSchema = z.object({
  ...
  impact_id: z.string(),
  application_periods: z.array(z.object({
    begin: z.string(),
    end: z.string(),
  })),
  status: z.string(),
  ...
  impacted_objects: z.array(z.object({
    pt_object: z.object({
      id: z.string(),
      name: z.string(),
      quality: z.number(),
...
export const TransportSchema = z.object({
  ...
  feed_publishers: z.array(z.object({
    id: z.string(),
    name: z.string(),
    url: z.string(),
    license: z.string(),
...
/**
 * End of file src/lib/schemas/journeys.ts
 */